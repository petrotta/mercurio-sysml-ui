...
export type CacheClearSummary = {
  workspace_snapshot_entries: number;
  project_semantic_lookup_entries: number;
  parsed_file_entries: number;
  file_mtime_entries: number;
  canceled_compile_entries: number;
  pending_workspace_ir_persists: number;
  workspace_ir_cache_files_deleted: number;
  stdlib_index_cache_files_deleted: number;
...
export type WorkspaceTreeEntryView = {
  name: string;
  path: string;
  is_dir: boolean;
};

export type WorkspaceTreeSnapshotResult = {
  project_root: string;
...
export type WorkspaceSymbolSnapshotTimingsView = {
  total_duration_ms: number;
  seed_symbol_index_ms: number;
  project_query_ms: number;
  library_query_ms: number;
  library_hydration_ms: number;
  library_requery_ms: number;
  library_metadata_ms: number;
};
